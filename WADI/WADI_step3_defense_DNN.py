...
data_x = pd.read_csv("attack_p1_x.csv")
...
train_x = pd.DataFrame(data_x_scale,columns = data_x.columns)[:314943]
train_adv = pd.read_csv("new_p1_adv.csv")[:3149363]
test_x = pd.DataFrame(data_x_scale,columns = data_x.columns)[314943:]
test_adv = pd.read_csv("new_p1_adv.csv")[3149363:]
