...
#Y_all = "Y.csv"
#################
Y_att = "Y_attack_SEN10.csv"
########
perturbation = 0.1

NORMALfile = "normal_all.csv"
#########
ATTACKfile = "X_ADV_SEN10.csv"
##########
MODEL = 'Defence_sen10.hdf5'
PREDICTEDy = 'PREDICTION_all.csv'#for original predicted y
PREDICTEDy_csv = 'PREDICTION_adv_sen0.1.csv' #for noised predicted y
GRADIENT = "GRADIENT_dnn_sen10.csv"
NOISE_sen = "dnn_X_ADV_SEN10.csv"
NOISE_all = "dnn_X_ADV_ALL10.csv"
